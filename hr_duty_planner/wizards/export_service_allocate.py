...
class AllocateService(models.TransientModel):
    ...
    date_from = fields.Date(string=_('From date'),
                            default=d_start.strftime(DEFAULT_SERVER_DATE_FORMAT))
    date_to = fields.Date(string=_('To date'),
    ...
    def generate_report(self):
        ...
        service_list = self.env['service.allocate'].search(domain, order='service_container_id,service_template_id,scheduled_start')
